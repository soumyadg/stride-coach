...
**The running coach that won't get you injured.** A Runna-style adaptive running-plan app that fixes Runna's documented problems (see `../research/`).
...
- **Daily readiness check** — sleep/soreness/energy → green/amber/red → today's session auto-adjusts (amber −20%, red → rest). This is the feedback loop Runna lacks.
...
- **Honest pricing / Why screen** — real free tier, £6.99 Pro vs Runna's £15.99 no-free-tier wall.
- **Persistence** via localStorage.

## Each feature maps to a real Runna complaint
